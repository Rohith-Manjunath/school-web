...
<div className="bg-secondary py-12 md:px-12">
      <div className=" mx-auto px-8 ">
        ...
        <h2 className="text-4xl font-bold text-white font-title mb-4">Gallery</h2>
        {
         ...
         <IoAddOutline className="w-full  font-semibold my-4 mx-1  text-[30px] tracking-wider text-white hover:text-white duration-200 transition-all hover:scale-105 active:scale-90 " onClick={()=>setIsModalOpen(true)}/>
        </button>
          <LuRefreshCcw className="w-full font-semibold my-4 text-[25px] tracking-wider text-white hover:text-white duration-200 transition-all hover:scale-105 active:scale-90  animate-spin " />
        </button>
          </div>
        }
        </div>
...
<div className='flex items-center justify-center gap-2'>
  <span>Preview :</span>
  <img src={image ? image : gallery?.avatar?.url } alt="" className='w-10 h-10 rounded-md' />

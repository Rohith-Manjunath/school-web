...
const GalleryAddContentModal = ({isModalOpen,setIsModalOpen,setPreview,setTitle,handleSubmit,handleImageUpload,postLoading,preview}) => {
  return (
      <Modal
      isOpen={isModalOpen}
...
export default GalleryAddContentModal